...
HD_PWD='C:/repo/vhdl-code-2024/display_7seg/display_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log X7segb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source X7segb.tcl -notrace
