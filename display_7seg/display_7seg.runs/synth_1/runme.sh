...
HD_PWD='C:/repo/vhdl-code-2024/display_7seg/display_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log X7segb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source X7segb.tcl
