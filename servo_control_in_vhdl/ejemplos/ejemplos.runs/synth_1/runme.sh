...
HD_PWD='C:/repo/servo_control_in_vhdl/ejemplos/ejemplos.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ejemplo2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ejemplo2.tcl
