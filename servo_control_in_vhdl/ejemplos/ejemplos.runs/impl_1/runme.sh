...
HD_PWD='C:/repo/servo_control_in_vhdl/ejemplos/ejemplos.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ejemplo2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ejemplo2.tcl -notrace
