...
HD_PWD='C:/repo/vhdl-code-2024/sistema_combinacional/sistema_combinacional.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_combinacional_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sistema_combinacional_top.tcl -notrace
